export function createQiniuProvider({ crypto, database, decryptSecret, writeApiLog, configuredRegions }) {
...
async function verifyQiniuAccount(id) {
  ...
  return { resources: qiniuResources, verifyAccount: verifyQiniuAccount };
}
