        ...
        {section === "settings" && (
          <section className="utility-page">
            ...
            <section className="settings-grid">
              ...
              <div className="settings-card"><div className="settings-icon amber"><Terminal size={22} /></div><div className="settings-copy"><strong>GitHub 开源仓库</strong><small>https://github.com/wanglei/cloudhub-tools</small></div><a className="secondary settings-link" href="https://github.com/wanglei/cloudhub-tools" target="_blank" rel="noreferrer">访问仓库 ↗</a></div>
            </section>
          </section>
        )}
        {panelDialog && (
